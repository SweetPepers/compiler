...
// 类型枚举
enum { I8, I16, I32, I64, U8, U16, U32, U64 };  // 0 1 2 3 
...
static char *castTable[10][10] = {
    ...
    {NULL,   NULL,   NULL,   NULL, i64u8, NULL,   NULL,   NULL}, // 从i8转换
    {i64i8,  NULL,   NULL,   NULL, i64u8, i64u16, NULL,   NULL}, // 从i16转换
...
static void storeGeneral(int Reg, int Offset, int Size) {
  ...
  switch (Size) {
  case 1:
    printLn("  sb %s, 0(t0)", ArgReg[Reg], Offset);
    return;
  case 2:
    printLn("  sh %s, 0(t0)", ArgReg[Reg], Offset);
    return;
  case 4:
    printLn("  sw %s, 0(t0)", ArgReg[Reg], Offset);
    return;
  case 8:
    printLn("  sd %s, 0(t0)", ArgReg[Reg], Offset);
    return;
  }
  unreachable();
}
